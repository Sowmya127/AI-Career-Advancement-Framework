...
function InterviewInterface({ params }: Props) {
  ...
  useEffect(() => {
    const fetchinterview = async () => {
      try {
        console.log("=== FETCHING SINGLE INTERVIEW ===");
        console.log("Trying to get interview with ID:", params.interviewId);
        
        const response = await getInterviewById(params.interviewId);
        
        console.log("=== SINGLE INTERVIEW RESPONSE ===");
        ...
        if (response) {
          ...
          console.log("✅ Interview set successfully:", response.name);
        } else {
          console.log("❌ No response - setting interview not found");
  ...
  // Debug state changes
  useEffect(() => {
    console.log("=== INTERVIEW INTERFACE DEBUG ===");
    console.log("Interview ID from params:", params.interviewId);
    console.log("Current interview state:", interview);
    console.log("Is Active:", isActive);
    console.log("Interview Not Found:", interviewNotFound);
  }, [interview, isActive, interviewNotFound, params.interviewId]);
