...
function Call({ interview }: InterviewProps) {
  ...
  const startConversation = async () => {
    ...
    console.log("=== DATA FOR REGISTER CALL ===");
    console.log("Data:", data);
    console.log("Interviewer ID:", interview?.interviewer_id);

    // TEMPORARILY BYPASS OLD USER CHECK FOR DEBUGGING
    console.log("🚀 BYPASSING OLD USER CHECK - PROCEEDING WITH INTERVIEW");
    
    try {
      console.log("=== CALLING REGISTER CALL API ===");
      ...
      console.log("Full response:", registerCallResponse);
      console.log("Access token:", registerCallResponse.data.registerCallResponse.access_token);
      console.log("Call ID:", registerCallResponse.data.registerCallResponse.call_id);

      if (registerCallResponse.data.registerCallResponse.access_token) {
        console.log("✅ Access token received - starting WebClient call");
        ...
        console.log("✅ Response record created:", response);
      } else {
        console.log("❌ Failed to register call - no access token");
      }
    } catch (error) {
      console.error("❌ Error in register call:", error);
    }

    /* COMMENTED OUT OLD USER CHECK - REMOVE THESE COMMENTS AFTER TESTING
  ...
  // Debug the interview prop
  useEffect(() => {
    console.log("=== CALL COMPONENT DEBUG ===");
    console.log("Interview prop received:", interview);
    console.log("Interview ID:", interview?.id);
    console.log("Interview name:", interview?.name);
    console.log("Interview is_active:", interview?.is_active);
    console.log("Interview is_anonymous:", interview?.is_anonymous);
  }, [interview]);
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="bg-white rounded-md md:w-[80%] w-[90%]">
        ...
        <a
          ...
          href="https://nextsteps.ai/"
          target="_blank"
        >
          <div className="text-center text-md font-semibold mr-2  ">
            Powered by{" "}
            <span className="font-bold">
              nextSteps<span className="text-indigo-600">.AI</span>
            </span>
          </div>
